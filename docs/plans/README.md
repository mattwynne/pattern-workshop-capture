...
| 005 | [Offer gentle diagram cleanup](005-publish-original-and-cleaned-diagrams.md) | **In progress** | Deterministic metadata-free normalized and gently cleaned image transformations | Complete comparison/selection UI and API; perceptual fixtures; human review to ensure drawings retain their character |
...
1. Complete Iteration 005 comparison and selection.
